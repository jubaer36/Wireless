...
#include <memory>
#include <stdint.h>
#include <fstream> //Added later by S.M. Sabit Bananee
...
#include "veins/modules/messages/DemoServiceAdvertisement_m.h" //Added later by S.M. Sabit Bananee
#include "veins/modules/messages/DemoSafetyMessage_m.h" //Added later by S.M. Sabit Bananee
#include "veins/modules/application/traci/TraCIDemo11pMessage_m.h"  //Added later by S.M. Sabit Bananee
...
class VEINS_API Mac1609_4 : public BaseMacLayer, public DemoBaseApplLayerToMac1609_4Interface {
    ...
    static bool logFileInitialized;  // flag to initialize only once
    static std::ofstream logFileChannelAccessDelay;
    static bool logFileInitializedChannelAccessDelay;
    //////////////////////////////////////////
