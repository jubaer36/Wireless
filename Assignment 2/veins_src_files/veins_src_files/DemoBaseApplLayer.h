...
using veins::TraCIScenarioManager; // Added later by S. M. Sabit Bananee
...
class VEINS_API DemoBaseApplLayer : public BaseApplLayer {
    ...
    static std::ofstream logFileNumCurrentVehicles;
    static bool logFileInitializedNumCurrentVehicles;  // flag to initialize only once
    //////////////////////////////////////////
